function addSWUnitToProject(modelName, asil, varargin)
%addSWUnitToProject create and add a new software unit to project
%   Create a new model folder containing an empty design model and empty
%   data dictionary associated with it. 
%   Folders for SW units are placed in the SW unit design and verification folders.
%   ASIL can be either 'QM'|'ASILA'|'ASILB'|'ASILC'|'ASILD'.
%   A thrid argument can be passed to specify if the model is
%   multi-instantiable.
%   
%   addSWUnitToProject(ModelName)
%   addSWUnitToProject(ModelName, ASIL)
%   addSWUnitToProject(ModelName, ASIL , 'Nonreusable')
...
% Create design, verification specification and verification results
% folders
