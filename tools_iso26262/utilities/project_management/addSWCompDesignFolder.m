function addSWCompDesignFolder(modelName, reuse, slddLink, asil)
%addSWCompDesignFolder Create an empty design folder for a software component in project
%   Create a design folder for a new software component containing empty design model
%   and an empty data dictionary associated with it.
...
dstDirName = ProjArtifacts.getCompDesignPath(modelName);
mkdir(dstDirName);
