...
resultFile = ProjArtifacts.getUnitMILResultsHLRFile(modelName);
rptFile = ProjArtifacts.getUnitMILResultsHLRPDF(modelName);
docDir = ProjArtifacts.getUnitMILResultsHLRDoc(modelName);
cvtFile = ProjArtifacts.getUnitMCovHLRCvt(modelName);
htmlFile = ProjArtifacts.getUnitMCovHLRHTML(modelName);
