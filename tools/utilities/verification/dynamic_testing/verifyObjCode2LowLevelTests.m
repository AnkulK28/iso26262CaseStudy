...
resultFile = ProjArtifacts.getUnitSPILLLRResFile(modelName, mode, isInstrumted);
rptFile = ProjArtifacts.getUnitSPILLLRResPDF(modelName, mode, isInstrumted);

cvtFile = ProjArtifacts.getUnitLLRCCovCvt(modelName, mode);
htmlFile = ProjArtifacts.getUnitLLRCCovHTML(modelName, mode);

testResDir = fileparts(resultFile);
...
sltest.testmanager.report(testResult, rptFile, ...
    'Author', authors, ...
    'Title',[modelName, instr, ' ', mode, ' Low-Level Tests'], ...
