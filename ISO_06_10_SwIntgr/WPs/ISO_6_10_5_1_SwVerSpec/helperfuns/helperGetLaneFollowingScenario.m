...
switch roadType
    case "Straight road"
        ...
        defaultVehiclePosition = [-100 0 0];
...
for i = 1:numLanes
    laneWidth(i) = abs(scenario.RoadSegments(startSegmentID).CenterLaneBoundaryLocation(i) - ...
                   scenario.RoadSegments(startSegmentID).CenterLaneBoundaryLocation(i+1));
end
